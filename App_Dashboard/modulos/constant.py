...
# Side Bar Formatation arguments
...
# Navigation Items Formatation
NAVITEM_STYLE = {"padding": "0rem 1rem"}

# The main content styles position it to the right of the sidebar and we add a padding.
CONTENT_STYLE = {"margin-left": "15rem", "padding": "0rem 0rem"}

# Initialize the column names of the dataset 
ID              = "ID"
STATUS          = "Status"
